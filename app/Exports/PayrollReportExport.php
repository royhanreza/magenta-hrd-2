...
class PayrollReportExport implements WithMultipleSheets, ShouldAutoSize
{
    ...
    public function __construct($startDatePeriod, $endDatePeriod)
    {
    ...
    public function sheets(): array
    {
        ...
        foreach ($companyInitials as $initial) {
            $sheets[] = new PayrollPerCompanySheet($initial, $this->startDatePeriod, $this->endDatePeriod);
        }
...
class PayrollPerCompanySheet implements FromView, WithTitle, ShouldAutoSize
{
    ...
    public function __construct($initial, $startDatePeriod, $endDatePeriod)
    {
    ...
    public function view(): View
    {
        ...
        }])->where('employee_id', 'like', $this->initial . '%')->get()->each(function ($employee) {
            $basicSalary = 0;
            $positionAllowance = 0;
