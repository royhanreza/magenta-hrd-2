            ...
            <div class="card">
                <div class="card-body">
                    <nav class="nav flex-column flex-sm-row">
                        ...
                        <a class="flex-sm-fill text-sm-center nav-link active" href="/company-policy">
                            <div class="d-flex justify-content-start align-items-center">
                                <div>
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        <div class="card-header d-flex">
                            <h5 class="card-header-title">List All Policies</h5>
                            <div class="toolbar ml-auto">
                                <a href="{{ url('company-policy/create') }}" class="btn btn-primary btn-sm"><i class="fas fa-fw fa-plus"></i> Add New</a>
                            </div>
                        </div>
                        <div class="card-body">
