        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
          ...
          <div class="row">
            <div class="col-md-6 xol-xs-12">
              <h2 style="color: #a6a6b7;"><i class="fas fa-calendar-alt"></i> {{ (int) date("01") }} {{ Helper::prettyMonth((int) date("m") - 1, "id") }} {{ date("Y") }} - {{ (int) date("t") }} {{ Helper::prettyMonth((int) date("m") - 1, "id") }} {{ date("Y") }}</h2>
            </div>
          ...
          <div class="card">
            <div class="card-header d-flex">
              ...
              <div class="toolbar ml-auto">
                <a href="/attendance/export/sheet?employee_id={{ $employee->id }}&start_date={{ date('Y-m-01') }}&end_date={{date('Y-m-t')}}" target="_blank" class="btn btn-primary btn-sm mr-1"><i class="fas fa-download"></i> Download</a>
              ...
              <div class="row align-items-center mb-3">
                <div class="col-md-3 col-xs-12">
                  <div class="input-group">
                    <input type="text" id="date1" class="form-control input-date-bs" value="{{ date('01-m-Y') }}" aria-describedby="basic-addon2" readonly required>
                ...
                <div class="col-md-3 col-xs-12">
                  <div class="input-group">
                    <input type="text" id="date2" class="form-control input-date-bs" value="{{ date('t-m-Y') }}" aria-describedby="basic-addon2" readonly required>
                    <div class="input-group-append">
                      <span class="input-group-text" id="basic-addon2"><i class="fas fa-calendar" style="line-height: 0;"></i></span>
                    </div>
                  </div>
...
<script>
  ...
  let app = new Vue({
    el: '#app',
    data: {
      // pendingAttendances: JSON.parse('{!! $pending_attendances !!}'),
      pendingAttendances: [],
      date1: '{{ date("Y-m-01") }}',
      date2: '{{ date("Y-m-t") }}',
    },
