      ...
      <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
          <div class="page-header">
            ...
            <!-- <pre>{{ print_r($userLoginPermissions) }}</pre> -->
          ...
          <div class="row">
            <div class="col-md-6 col-xs-12">
              ...
              <!-- <a href="{{ url('employee/export') }}" class="btn btn-success btn-sm">
                <i class="fas fa-download fa-xs"></i> Export as .xlsx
              </a> -->
            </div>
            <div class="col-md-6 col-xs-12">
                ...
                <div class="card-header bg-light">
                  <div>
                    <ul class="d-flex flex-row-reverse align-items-center m-0 list-unstyled text-right">
                      <li class="ml-3">
                        <div class="dropdown dropleft">
                          ...
                          <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <a class="dropdown-item" href="/employee/setting/{{ $employee->id }}/salary">Pengaturan</a>
                            @endif
                          </div>
                        </div>
                      ...
                      @endif
                      @if(in_array("deleteEmployee", $userLoginPermissions))
