                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" id="overtime-date" class="form-control form-control-sm input-date-bs effective-date" aria-describedby="basic-addon2" readonly required>
    ...
    let app = new Vue({
        ...
        methods: {
            ...
            sendData: function() {
                ...
                axios.post('/overtime-submission', formData)
