                ...
                <table class="table table-bordered use-datatable">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <!--<td class="text-center">{{ $leave->taken_leave + $leave->taken_carry_forward }}</td>-->
                      <td class="text-center">{{ $leave->total_leave - $leave->taken_leave }}</td>
                      <td class="text-center">
                        @if(in_array("editLeaveData", $userLoginPermissions))
                        <button class="btn btn-light btn-sm" @click="openEditLeaveModal({{ $leave->id }}, {{ $leave->total_leave }},{{ $leave->taken_leave }}, {{ $leave->total_carry_forward }})"><i class="fas fa-pencil-alt"></i></button>
                        @endif
                      </td>
                    </tr>
                    @endforeach
