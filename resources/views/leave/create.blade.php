      ...
      <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
          <div class="page-header">
            <h2 class="pageheader-title">Cuti </h2>
            <!-- <p class="pageheader-text">Nulla euismod urna eros, sit amet scelerisque torton lectus vel mauris facilisis faucibus at enim quis massa lobortis rutrum.</p> -->
            <div class="page-breadcrumb">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="/" class="breadcrumb-link">Dashboard</a></li>
                  <li class="breadcrumb-item"><a href="/employee" class="breadcrumb-link">Cuti</a></li>
                  ...
                  <div class="col-md-9">
                    ...
                    <div class="form-group row justify-content-between">
                      ...
                      <div class="col-sm-9">
                        ...
                        <span v-if="totalTakenLeave > (leaveAllowance - leaveTaken)"><i class="fas fa-exclamation-triangle fa-xs text-warning"></i> Jumlah hari telah melewati batas maksimal</span>
                      </div>
                    </div>
                    <!-- <div class="form-group row justify-content-between">
