  ...
  <div class="dashboard-ecommerce">
    <div class="container-fluid dashboard-content ">
      ...
      <div class="row">
        ...
        <!-- ============================================================== -->
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
          <form @submit.prevent="addPaySlip">
            <div class="card">
              <!-- 1 -->
                ...
                <table class="table">
                  ...
                  <tbody>
                    <tr v-for="(selectedSalaryIncome, index) in selectedSalaryIncomes" :key="selectedSalaryIncome.id">
                      ...
                      <td>@{{ selectedSalaryIncome.type }}</td>
                      <td class="text-center">
                        <div class="btn-group" role="group" aria-label="Action Buttons">
                          <button @click="unselectSalaryIncome(index)" type="button" class="btn btn-sm btn-light btn-delete" data-id=""><i class="fas fa-fw fa-trash"></i></button>
                        </div>
                      </td>
                    </tr>
                  </tbody>
                ...
                <table class="table">
                  ...
                  <tbody>
                    <tr v-for="(selectedSalaryDeduction, index) in selectedSalaryDeductions" :key="selectedSalaryDeduction.id">
                      ...
                      <td>@{{ selectedSalaryDeduction.type }}</td>
                      <td class="text-center">
                        <div class="btn-group" role="group" aria-label="Action Buttons">
                          <button type="button" @click="unselectSalaryDeduction(index)" class="btn btn-sm btn-light btn-delete" data-id=""><i class="fas fa-fw fa-trash"></i></button>
                        </div>
                      </td>
                    </tr>
                  </tbody>
...
<script>
  let app = new Vue({
    ...
    data: {
      ...
      longPeriod: 'monthly',
      monthlyFirstDay: 1,
      weeklyFirstDay: 'monday',
      dailyNumberOfDays: 31,
      dailyPreviousPaySlipDate: '',
      incomeLastDayAttendance: 0,
      ...
      selectedSalaryIncomes: [],
      selectedSalaryDeductions: [],
    ...
    methods: {
      ...
      unselectSalaryIncome: function(index) {
        this.selectedSalaryIncomes.splice(index, 1);
      },
