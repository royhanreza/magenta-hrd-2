        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
          <div class="card">
            <div class="card-header d-flex">
              <h5 class="card-header-title"><i class="fas fa-th"></i> Laporan BPJS</h5>
            </div>
            <div class="card-body">
              <div class="row">
                <div class="col-sm-4">
                ...
                <tbody>
                  ...
                  <tr class="text-center">
                    ...
                    @if(((int) $report['month'] < (int) date('m')) && (int) $report['year']>= (int) date('Y'))
                      ...
                      @endif
                      @else
                      <td><a href="{{ Storage::disk('s3')->url($report['file'] ) }}" target="_blank" class="text-primary"><i class="fas fa-file-alt"></i> Laporan BPJS {{ $months[(int) $report['month'] - 1] }} {{ $year }}</a></td>
                      @endif
                  </tr>
                  @endforeach
                </tbody>
  ...
  let app = new Vue({
    ...
    methods: {
      onSelectYear: function() {
        window.location.href = '/report/bpjs/?year=' + this.year;
      },
