            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <form autocomplete="off" @submit.prevent="submitForm">
                        <div class="card">
                            <h5 class="card-header">Ubah Lokasi Kantor</h5>
                            <div class="card-body">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input v-model="locationName" type="text" class="form-control form-control-sm" id="location-name" required>
                                    </div>
                                    <div class="form-group col-md-6">
...
<script>
    ...
    let app = new Vue({
        ...
        data: {
            ...
            locationHead: '{{ $location->employee_id }}',
        ...
        methods: {
            submitForm: function() {
                ...
                let vm = this;
                vm.loading = true;
                axios.patch('/company-location/{{ $location->id }}', {
...
<script>
    ...
    initMap(app.$data.longitude, app.$data.latitude);
