                            ...
                            <div class="card-body">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label for="role-name">Nama<sup class="text-danger">*</sup></label>
                                        <input v-model="name" type="text" class="form-control form-control-sm" id="role-name" placeholder="Contoh: Admin" required>
                                    </div>
                                    <!-- <div class="form-group col-md-6">
...
<script type="" src="{{ asset('libs/js/permissions.js') }}"></script>
@endsection
