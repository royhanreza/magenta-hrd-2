                                ...
                                <table class="table table-striped use-datatable">
                                    ...
                                    <tbody>
                                        <tr v-for="(attendance, index) in attendances">
                                            ...
                                            <!-- End:Status -->
                                            <!-- Jam Masuk & Keluar -->
                                            <td class="text-center"><input type="time" data-date="{{ date('Y-m-d', strtotime($date)) }}" :data-employee="attendance.id" :data-id="attendance.checkin_id" @change="updateClockIn($event, index)" class="form-control form-control-sm attendance-time" :value="attendance.clock_in"></td>
                                            <td class="text-center"><input type="time" data-date="{{ date('Y-m-d', strtotime($date)) }}" :data-employee="attendance.id" :data-id="attendance.checkout_id" @change="updateClockOut($event, index)" class="form-control form-control-sm attendance-time" :value="attendance.clock_out"></td>
