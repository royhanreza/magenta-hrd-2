                            ...
                            <div class="card-body">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <select v-model="company" v-on:change="onChangeCompany($event)" name="company" id="company" class="form-control form-control-sm" required>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="department">Main Department<sup class="text-danger">*</sup></label>
                                        <select2 v-model="department" :options="departments" id="department" class="form-control form-control-sm" v-bind:disabled="departmentLoading" required>
...
<script>
    ...
    let app = new Vue({
        ...
        data: {
            ...
            company: '{{ $designation->department->company_id }}',
        ...
        methods: {
            submitForm: function() {
                ...
                let vm = this;
                vm.loading = true;
                axios.patch('/company-designation/{{ $designation->id }}', {
                        name: this.name,
