      ...
      <div class="card">
        <div class="card-body">
          <nav class="nav flex-column flex-sm-row">
            ...
            <a class="flex-sm-fill text-sm-center nav-link active" href="/company-designation">
              <div class="d-flex justify-content-start align-items-center border-right">
                <div>
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
          <div class="card">
            <div class="card-header d-flex">
              <h5 class="card-header-title">List All Divisions</h5>
              <div class="toolbar ml-auto">
                <a href="{{ url('company-designation/create') }}" class="btn btn-primary btn-sm"><i class="fas fa-fw fa-plus"></i> Add New</a>
              </div>
            </div>
            <div class="card-body">
                ...
                <table class="table table-bordered use-datatable">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{ $designation->department->company->name }}</td>
                      <td class="text-center" style="width: 15%;">
                        <div class="btn-group" role="group" aria-label="Action Buttons">
                          <a href="{{ url('company-designation/edit') . '/' . $designation->id }}" class="btn btn-sm btn-light"><i class="fas fa-fw fa-pencil-alt"></i></a>
                          <button type="button" class="btn btn-sm btn-light btn-delete" data-id="{{ $designation->id }}"><i class="fas fa-fw fa-trash"></i></button>
                          <!-- <div class="dropdown">
